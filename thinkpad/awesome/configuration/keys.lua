...
-- setup for useless_gap shortcut
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn("pulsemixer --change-volume +10") end),
    awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn("pulsemixer --change-volume -10") end),
