...
(def-doom-theme doom-xresources
  ...
  ((bg         '("#002b36" nil       nil          ))
   ...
   (base0      '("#002b36" "#002b36"   "black"      ))
   (base1      '("#002b36" "#002b36" "brightblack"))
   (base2      '("#002b36" "#002b36" "brightblack"))
   (base3      '("#073642" "#073642" "brightblack"))
   (base4      '("#224750" "#224750" "brightblack"))
   (base5      '("#224750" "#224750" "brightblack"))
   (base6      '("#657b83" "#657b83" "brightblack"))
   (base7      '("#657b83" "#657b83" "brightblack"))
   (base8      '("#839496" "#839496" "brightwhite"))
   (fg         '("#93a1a1" "#93a1a1" "brightwhite"))
   (fg-alt     '("#657b83" "#657b83" "white"))

   (color0      '("#073642" "#073642" "color0"))
   (color8      '("#224750" "#224750" "color8"))
   (grey       '("#657b83" "#657b83" "brightblack"))
   (red        '("#dc322f" "#dc322f" "red"))
   (orange     '("#ca6721" "#ca6721" "brightred"))
   (green      '("#859900" "#859900" "green"))
   (teal       green)
   (yellow     '("#b58900" "#b58900" "yellow"))
   (blue       '("#268bd2" "#268bd2" "brightblue"))
   (dark-blue  '("#268bd2" "#268bd2" "blue"))
   (magenta    '("#6c71c4" "#6c71c4" "magenta"))
