...
local get_taglist = function(s)
    ...
    local ghost = gears.surface.load_uncached(
                      gfs.get_configuration_dir() .. "icons/clean/occupied.png")
    local ghost_icon = gears.color.recolor_image(ghost, beautiful.xcolor8)
    local dot = gears.surface.load_uncached(
                    gfs.get_configuration_dir() .. "icons/clean/vacant.png")
    local dot_icon = gears.color.recolor_image(dot, beautiful.xcolor8)
    local pacman = gears.surface.load_uncached(
                       gfs.get_configuration_dir() .. "icons/clean/vacant.png")
    local pacman_icon = gears.color.recolor_image(pacman, beautiful.xcolor6)
