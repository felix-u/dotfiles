local palette = {
    background  = {"$(wq lightbg)", 0,  "background"},
    foreground  = {"$(wq lightfg)", 16, "foreground"},
    black00     = {"$(wq light0)",  1,  "black00"},
