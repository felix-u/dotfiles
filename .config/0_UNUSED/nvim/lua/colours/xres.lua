-- This file should be edited by the user. Read the instructions of each section and then edit them as desic.red01.
...
local c = require "colours.palette"
--[[ Step 4: highlights
...
```lua
	<highlight group name> = {
		...
		-- The |highlight-blend| value, if one is desic.red01.
		[, blend = <integer>]
...
```lua
	SpellBad = { -- ← name of the highlight group
		...
		fg = c.red01, -- foureground color
		style = { -- the style
			'undercurl', -- undercurl (squiggly line)
			color = c.red01 -- the color of the undercurl
		}
	},
	SpellWorse = 'SpellBad'
```
...
local highlight_groups = {
	...
	DiffChange = {},
	DiffDelete = function(self) return {fg = self.DiffAdd.fg, bg = c.red01} end,
	DiffText   = function(self) return {fg = self.DiffAdd.fg, bg = c.yellow03} end,
	...
	goRedefinedIdentifiers = 'Constant',
	goReceiver     = 'goBlock',
	...
	diffAdded               = 'NORMAL',
	diffRemoved             = 'NORMAL',
	gitcommitHeader         = 'NORMAL',
	gitcommitDiscardedFile  = 'NORMAL',
	gitcommitOverFlow       = 'NORMAL',
	gitcommitSelectedFile   = 'NORMAL',
	gitcommitSummary        = 'NORMAL',
	gitcommitUntrackedFile  = 'NORMAL',
	gitconfigAssignment     = 'NORMAL',
	gitconfigEscape         = 'NORMAL',
	gitconfigNone           = 'NORMAL',
	gitconfigSection        = 'NORMAL',
	gitconfigVariable       = 'NORMAL',
	gitrebaseBreak          = 'NORMAL',
	gitrebaseCommit         = 'NORMAL',
	gitrebaseDrop           = 'NORMAL',
	gitrebaseEdit           = 'NORMAL',
	gitrebaseExec           = 'NORMAL',
	gitrebaseFixup          = 'NORMAL',
	gitrebaseMerge          = 'NORMAL',
	gitrebasePick           = 'NORMAL',
	gitrebaseReset          = 'NORMAL',
	gitrebaseReword         = 'NORMAL',
	gitrebaseSquash         = 'NORMAL',
	...
	IndentGuidesOdd  = {bg = c.black08},
	IndentGuidesEven = {bg = c.gray07},
	...
	BufferVisibleMod    = function(self) return {fg = c.white15, bg = self.BufferVisible.bg, style = 'italic'} end,
	...
	TodoFgNOTE = 'HintMsg',
	TodoFgPERF = 'InfoMsg',
	TodoFgTODO = {fg = c.cyan06, style = 'italic'},
	TodoFgWARN = function(self) return {fg = self.WarningMsg.fg} end,

	TodoBgFIX = function(self) return {fg = c.black00, bg = self.ErrorMsg.fg, style = {'bold', 'italic', 'nocombine'}} end,
	TodoBgHACK = function(self) return {fg = c.black00, bg = self.Todo.bg, style = {'bold', 'italic', 'nocombine'}} end,
	TodoBgNOTE = function(self) return {fg = c.black00, bg = self.Hint.bg, style = {'bold', 'italic', 'nocombine'}} end,
	TodoBgPERF = function(self) return {fg = c.black00, bg = self.Info.bg, style = {'bold', 'italic', 'nocombine'}} end,
	TodoBgTODO = {fg = c.black00, bg = c.cyan06, style = {'bold', 'italic', 'nocombine'}},
	TodoBgWARN = function(self) return {fg = c.black00, bg = self.Warning.bg, style = {'bold', 'italic', 'nocombine'}} end,
	...
	packerSuccess = function(self) return {fg = c.green02, style = self.packerFail.style} end,
...
--[[ Step 5: Terminal Colors
	...
	While you are certainly free to make colors 0 to 7 shades of c.blue04,
