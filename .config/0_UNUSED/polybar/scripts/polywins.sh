...
active_text_color="$(xquery color15)"
active_bg="$(xquery color0)"
active_underline="$(xquery color8)"
active_left_char=""
active_right_char=""

inactive_text_color="$(xquery color7)"
inactive_bg="$(pastel mix $(xquery color0) $(xquery background) | pastel format hex)"
inactive_underline=
inactive_left_char=""
inactive_right_char=""
...
empty_fg="$(xquery color4)"
# empty_desktop_message="%{F$inactive_bg}$inactive_left_char%{F-}%{B$inactive_bg}%{F$empty_fg}felix@$(hostname)%{F-}%{B-}%{F$inactive_bg}$inactive_right_char%{F-}"
...
active_left="%{F$active_bg}$active_left_char%{F-}%{F$active_text_color}"
active_right="%{F-}%{F$active_bg}$active_right_char%{F-}"

inactive_left="%{F$inactive_bg}$inactive_left_char%{F-}%{F$inactive_text_color}"
inactive_right="%{F-}%{F$inactive_bg}$inactive_right_char%{F-}"
